...
class SleepTableViewController: UITableViewController {
    ...
    @IBOutlet weak var undoButton: UIBarButtonItem! //disable until TV #2 is visible
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        undoButton.enabled = false //undo button is not showing up on screen!
    ...
    @IBAction func cancelButtonClick(sender: AnyObject) {
        //Return to home page w/ category selection:
    ...
    @IBAction func saveButtonClick(sender: AnyObject) {
        //Captures all entered information in a dictionary & sends it to the database.
